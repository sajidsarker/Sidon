/// DrawUnitInfo(id1, alignment)
{
    ...
    if (!argument1) {
        ...
        DrawValueColour( 32, view_hview[0] - 40, 48, argument0.myName, c_black );
    ...
    if (argument1) {
        ...
        DrawValueColour( view_wview[0] - 16 - string_length(argument0.myName), view_hview[0] - 40, 48, argument0.myName, c_black );
        if ( argument0.myFaction != 99 ) {
